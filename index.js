...
btn.addEventListener("click",function(){
   ...
   if(nomProduit.value==""){
    ...
    produits.insertAdjacentHTML("afterend",`<div class="card" style="width: 18rem;">

  <div class="card-body">
    <h5 class="card-title">nom produit:${produit.nom}</h5>
    <p class="card-text">categorie:${produit.categorie}</p>
    <p class="card-text">prix:${produit.prix}</p>
    <p class="card-text">quantite:${produit.quantite}</p>
    <a href="#" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-square-fill" viewBox="0 0 16 16">
